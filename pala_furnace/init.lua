...
minetest.register_node("pala_furnace:furnace", {
	...
	tiles = {
		"default_furnace_top.png^[colorize:#fc4141:100", "default_furnace_bottom.png^[colorize:#fc4141:100",
		"default_furnace_side.png^[colorize:#fc4141:100", "default_furnace_side.png^[colorize:#fc4141:100",
		"default_furnace_side.png^[colorize:#fc4141:100", "default_furnace_front.png^[colorize:#fc4141:100"
	},
	paramtype2 = "facedir",
...
minetest.register_node("pala_furnace:furnace_active", {
	description = S("Burning Furnace"),
	_doc_items_create_entry = false,
	tiles = {
		"default_furnace_top.png^[colorize:#fc4141:100", "default_furnace_bottom.png^[colorize:#fc4141:100",
		"default_furnace_side.png^[colorize:#fc4141:100", "default_furnace_side.png^[colorize:#fc4141:100",
		"default_furnace_side.png^[colorize:#fc4141:100", "default_furnace_front_active.png^[colorize:#fc4141:100",
	},
	paramtype2 = "facedir",
	paramtype = "light",
