...
local sword_longdesc = [[Swords are great in melee combat, as they are fast, 
	deal high damage and can endure countless battles. 
	Swords can also be used to cut down a few particular blocks, such as cobwebs.]]
local pickaxe_longdesc = [[Pickaxes are mining tools to mine hard blocks, such as stone. 
